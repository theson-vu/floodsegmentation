...
echo "Running baseline_deep 1 Sen1"
python train_model.py --name sen1_baseline_deep_final_seed1 --epochs 50 --sen1 --image --deep --lr 1e-4 --seed 1
echo "Running baseline_deep 2 Sen1"
python train_model.py --name sen1_baseline_deep_final_seed2 --epochs 50 --sen1 --image --deep --lr 1e-4 --seed 2
echo "Running baseline_deep 3 Sen1"
python train_model.py --name sen1_baseline_deep_final_seed3 --epochs 50 --sen1 --image --deep --lr 1e-4 --seed 3

echo "Running deep 1 Sen1"
python train_model.py --name sen1_deep_final_seed1 --epochs 50 --sen1 --deep --lr 1e-4 --seed 1
echo "Running deep 2 Sen1"
python train_model.py --name sen1_deep_final_seed2 --epochs 50 --sen1 --deep --lr 1e-4 --seed 2
echo "Running deep 3 Sen1"
python train_model.py --name sen1_deep_final_seed3 --epochs 50 --sen1 --deep --lr 1e-4 --seed 3
